...
*   **`/compact`**: Manually forces the `OpenLCM` engine to compact the session history immediately, replacing old turns with scaffold summary nodes to free up context window space.
