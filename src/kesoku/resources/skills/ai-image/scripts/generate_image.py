...
def main():
    ...
    parser.add_argument("--aspect-ratio", default="9:16", choices=["1:1", "16:9", "9:16", "3:4", "4:3"], 
        help="The aspect ratio of the generated image (Ignored if model doesn't support it via generate_content).")
    parser.add_argument("--image-size", default="2K", choices=["512", "1K", "2K", "4K"],
    ...
    try:
        ...
        print("Please ensure authentication (API Key or Vertex AI) is correctly configured in your environment.", file=sys.stderr)
        sys.exit(1)
